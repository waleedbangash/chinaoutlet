                    ...
                    <div id="myCarousel-2" class="carousel slide">
                        ...
                        <div class="carousel-inner">
                            ...
                            <div class="item active"  >
                                <img src="{{asset('public/asset/img/camera1.jpg')}}"  class="img-responsive" alt="" />
                            </div>
                            <!-- Slide 2 -->
                            <div class="item">
                                <img src="{{asset('public/asset/img/camera2.jpg')}}" class="img-responsive" alt="" />
                            </div>
                            <!-- Slide 3 -->
                            <div class="item">
                                <img src="{{asset('public/asset/img/camera3.jpg')}}" class="img-responsive" alt="" />
                            </div>
                        </div>
